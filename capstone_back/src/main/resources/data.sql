...
insert into product (name, category, price, stock) values ('Big Boi Hat', 'BOATS', 99.99, 200);
...
insert into product (name, category, price, stock) values ('Thicc Oats', 'BOATS', 5.99, 1000);
insert into product (name, category, price, stock) values ('Special Goat', 'BOATS', 79.33, 57);
