...
insert into users (user_first_name, user_last_name, username, user_address, user_password, wallet) values ('Alex', 'Leaver Hernandez', 'ALH', 'Cambridge', '$2a$10$e59rGaFvpijWXLh03j0aZOzBYQNrIRIjlB8sGwLvBL35fecblsW1m', 1000);
insert into users (user_first_name, user_last_name, username, user_address, user_password, wallet) values ('Peace', 'Akib', 'PAK', 'London', '$2a$10$e59rGaFvpijWXLh03j0aZOzBYQNrIRIjlB8sGwLvBL35fecblsW1m', 1000);
insert into users (user_first_name, user_last_name, username, user_address, user_password, wallet) values ('Carol', 'Ziqiong', 'CZI', 'Bristol', '$2a$10$e59rGaFvpijWXLh03j0aZOzBYQNrIRIjlB8sGwLvBL35fecblsW1m', 1000);
